...
/**
 * Migrate sessions from ~/.tinny-pi/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.tinny-pi/agent/ instead of
 * ~/.tinny-pi/agent/sessions/<encoded-cwd>/. This migration moves them
