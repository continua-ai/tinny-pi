 ...
 * Encodes cwd into a safe directory name under ~/.tinny-pi/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.tinny-pi/agent/sessions/<encoded-cwd>/).
	 */
